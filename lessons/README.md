...
| 2026-08-15 | [Two bad samples and I declared Instagram dead](2026-08-15-instagram-logged-out-wall.md) | Instagram answers deleted, restricted and never-existed with the same "may be broken" shell, so a platform-is-dead conclusion needs a post proven public by a third party — the real faults were a log that blamed a secret it had, a retired GraphQL `doc_id`, and one instance standing in for a fallback list. |
