-- When we last asked the billing provider about this user's subscription.
--
...
-- request against our account-wide API key — enough to get it rate limited and
-- take the customer portal down for everyone.
--
-- Separate from ls_updated_at, which carries the provider's own timestamp and
